...
export default function ResetPasswordPage() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    if (password.length < 12) { setMessage('Password must be at least 12 characters.'); setState('error'); return; }
