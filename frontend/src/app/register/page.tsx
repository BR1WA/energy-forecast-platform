      ...
      <div className="mx-auto flex min-h-[calc(100vh-64px)] max-w-md items-center px-5 py-10">
        <section className="w-full border border-white/[0.1] bg-[#0d1420] p-6 sm:p-8">
          ...
          <form onSubmit={submit} className="mt-6 space-y-4">
            ...
            <Button id="register-submit" type="submit" disabled={submitting} className="h-11 w-full">{submitting ? <Loader2 className="h-4 w-4 animate-spin" /> : <ArrowRight className="h-4 w-4" />}{submitting ? 'Creating account' : 'Create account'}</Button>
          </form>
