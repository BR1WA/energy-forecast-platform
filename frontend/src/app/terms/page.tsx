...
export default function TermsPage() {
  return (
    <PublicPolicyLayout title="Terms of service">
      ...
      <section><h2 className="text-lg font-semibold text-white">Availability and changes</h2><p className="mt-2">Optional providers and the 168-hour or 30-day daily forecast may be unavailable when disabled, unhealthy, or missing sufficient meter history. Material terms changes must be published with a new effective date by the service owner.</p></section>
