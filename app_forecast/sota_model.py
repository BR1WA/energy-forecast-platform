"""
SOTA Time-Series Forecasting Model Architectures.
Must match the training notebook definitions EXACTLY to load saved weights.
"""
import torch
...
class SOTAForecastingModel(nn.Module):
    """
    Advanced Recurrent-Attention Hybrid with:
    - Multi-Scale Patching (P1=8, P2=24)
    - RevIN
    - Cyclical Calendar Embeddings
    - CI + Cross-Variable Attention
    """
    ...
    def forward(self, x_targets, x_calendar):
        ...
        # 5. Project & Concatenate embeddings
