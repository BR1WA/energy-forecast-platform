"""Production inference wrapper for the 30-day Chronos-2 LoRA release."""
...
class MonthProductionForecaster:
    """Load the pinned adapter and forecast calibrated daily quantiles."""
    ...
    def __init__(self, release_dir: Path | str, device: str = "cpu") -> None:
        ...
        if self.manifest["contract"]["inference_dtype"] != "float32":
            raise RuntimeError("The release contract requires FP32 inference.")
