    ...
    def __init__(self):
        ...
        self.available_models_metadata = {
            ...
            'patchtst_168': {
                ...
                'training_metrics': {'mae': 0.4630, 'rmse': 0.6560, 'mape': 55.40, 'r2_score': 0.2945},
                'parameters': {
            ...
            'itransformer_168': {
                ...
                'training_metrics': {'mae': 0.4454, 'rmse': 0.6350, 'mape': 52.80, 'r2_score': 0.3082},
                'parameters': {
                    'lookback_window': '512 hours',
                    'forecast_horizon': '168 hours',
                    'd_model': '128',
            ...
            'patchtst_720': {
                ...
                'training_metrics': {'mae': 0.4950, 'rmse': 0.7020, 'mape': 60.10, 'r2_score': 0.1697},
                'parameters': {
            ...
            'itransformer_720': {
                ...
                'training_metrics': {'mae': 0.4579, 'rmse': 0.6540, 'mape': 56.20, 'r2_score': 0.2417},
                'parameters': {
                    'lookback_window': '1440 hours',
                    'forecast_horizon': '720 hours',
                    'd_model': '128',
